...
// (REQ-1202, 3-5, configurable). No seeding/admin/endpoint work for this
// story (S-081) — round-scheduling wiring for "xg-path" is S-084; tests
// construct PathTemplate fixtures directly.
