...
// restricts Tier 0 grid content to Country x Club only; Trophy is Tier 1,
// REQ-108) — the field exists now so the shape matches
// implementation-document.md §5 and doesn't need a later migration.
