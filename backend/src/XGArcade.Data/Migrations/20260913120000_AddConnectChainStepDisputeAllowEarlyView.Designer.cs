...
namespace XGArcade.Data.Migrations
{
    ...
    partial class AddConnectChainStepDisputeAllowEarlyView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.Challenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChallengerUserId", "ChallengedUserId");
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.ConnectChainStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("CandidatePlayerId")
                        .HasColumnType("uuid");

                    b.Property<bool>("ClosesChain")
                        .HasColumnType("boolean");

                    b.Property<string>("ClosingClubName")
                        .HasColumnType("text");

                    b.Property<int?>("ClosingOverlapEndYear")
                        .HasColumnType("integer");

                    b.Property<int?>("ClosingOverlapStartYear")
                        .HasColumnType("integer");

                    b.Property<Guid>("ConnectMatchId")
                        .HasColumnType("uuid");

                    b.Property<bool>("HasPendingDispute")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsValid")
                        .HasColumnType("boolean");

                    b.Property<string>("MatchedClubName")
                        .HasColumnType("text");

                    b.Property<int?>("MatchedOverlapEndYear")
                        .HasColumnType("integer");

                    b.Property<int?>("MatchedOverlapStartYear")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CandidatePlayerId");

                    b.HasIndex("ConnectMatchId", "UserId", "Position", "AttemptNumber");

                    b.ToTable("ConnectChainSteps");
                });

            modelBuilder.Entity("XGArcade.Data.Entities.ConnectChainStepDispute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AllowEarlyView")
                        .HasColumnType("boolean");

                    b.Property<string>("ClaimedClubName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<Guid>("ConnectChainStepId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConnectChainStepId")
                        .IsUnique();

                    b.ToTable("ConnectChainStepDisputes");
                });

            modelBuilder.Entity("XGArcade.Data.Entities.ConnectDisputeDataCorrectionSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ConnectChainStepDisputeId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("PrecedingPlayerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConnectChainStepDisputeId");

                    b.HasIndex("CreatedAt");

                    b.HasIndex("PrecedingPlayerId");

                    b.ToTable("ConnectDisputeDataCorrectionSuggestions");
                });

            modelBuilder.Entity("XGArcade.Data.Entities.ConnectChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConnectMatchId", "SentAt");

                    b.ToTable("ConnectChatMessages");
                });

            modelBuilder.Entity("XGArcade.Data.Entities.ConnectMatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("PlayerABustedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("PlayerAScore")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("PlayerATimedOutAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("PlayerAUserId")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("PlayerBBustedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("PlayerBScore")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("PlayerBTimedOutAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("ConnectMatches");
                });

            modelBuilder.Entity("XGArcade.Data.Entities.ConnectTargetPick", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConnectMatchId", "UserId")
                        .IsUnique();

                    b.ToTable("ConnectTargetPicks");
                });
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.FriendRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.Friendship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.HigherLowerAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("CurrentBaselinePlayerId")
                        .HasColumnType("uuid");

                    b.Property<int>("CurrentBaselineValue")
                        .HasColumnType("integer");

                    b.Property<bool>("HasEnded")
                        .HasColumnType("boolean");

                    b.Property<Guid>("HigherLowerInstanceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CurrentBaselinePlayerId");

                    b.HasIndex("HigherLowerInstanceId", "UserId")
                        .IsUnique();

                    b.ToTable("HigherLowerAttempts");
                });

            modelBuilder.Entity("XGArcade.Data.Entities.HigherLowerComparator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HigherLowerInstanceId", "SequencePosition")
                        .IsUnique();

                    b.HasIndex("PlayerId");

                    b.ToTable("HigherLowerComparators");
                });

            modelBuilder.Entity("XGArcade.Data.Entities.HigherLowerInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("BaselinePlayerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BaselinePlayerId");

                    b.ToTable("HigherLowerInstances");
                });
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.MatchmakingOptIn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.PredictPlayerLock", b =>
                {
                    b.Property<Guid>("PredictInstanceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("PredictInstanceId", "UserId");

                    b.ToTable("PredictPlayerLocks");
                });
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.ConnectChainStep", b =>
                {
                    b.HasOne("XGArcade.Data.Entities.ConnectMatch", null)
                        .WithMany()
                        .HasForeignKey("ConnectMatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XGArcade.Data.Entities.Player", null)
                        .WithMany()
                        .HasForeignKey("CandidatePlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.ConnectChainStepDispute", b =>
                {
                    b.HasOne("XGArcade.Data.Entities.ConnectChainStep", null)
                        .WithMany()
                        .HasForeignKey("ConnectChainStepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.ConnectDisputeDataCorrectionSuggestion", b =>
                {
                    b.HasOne("XGArcade.Data.Entities.ConnectChainStepDispute", null)
                        .WithMany()
                        .HasForeignKey("ConnectChainStepDisputeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("XGArcade.Data.Entities.Player", null)
                        .WithMany()
                        .HasForeignKey("PrecedingPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.HigherLowerAttempt", b =>
                {
                    b.HasOne("XGArcade.Data.Entities.HigherLowerInstance", null)
                        .WithMany()
                        .HasForeignKey("HigherLowerInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XGArcade.Data.Entities.Player", null)
                        .WithMany()
                        .HasForeignKey("CurrentBaselinePlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("XGArcade.Data.Entities.HigherLowerInstance", b =>
                {
                    b.HasOne("XGArcade.Data.Entities.Player", null)
                        .WithMany()
                        .HasForeignKey("BaselinePlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
