...
public class LeaderboardServiceTests
{
    ...
    public async Task REQ717_GetClosedRoundLeaderboardAsync_GuestParticipant_AppearsRankedExactlyLikeAnyOtherParticipant()
    {
        ...
        await SeedGuessAsync(round.Id, realMember.Id, Guid.NewGuid(), isCorrect: false, attemptCount: 2, finalPoints: ScoringRules.MaxPointsPerCell);
    ...
    public async Task REQ407_GetActiveRoundLeaderboardAsync_RanksAscendingByTotalPoints()
    {
        ...
        // change.
        await SeedGuessAsync(round.Id, alex.Id, cellA, isCorrect: false, attemptCount: 2);
        await SeedGuessAsync(round.Id, alex.Id, cellB, isCorrect: false, attemptCount: 2);
    ...
    public async Task REQ407_GetActiveRoundLeaderboardAsync_TiedTotalPoints_TieBreaksByDisplayNameAscending()
    {
        ...
        await SeedGuessAsync(round.Id, zoe.Id, cellA, isCorrect: false, attemptCount: 2);
        await SeedGuessAsync(round.Id, amy.Id, cellB, isCorrect: false, attemptCount: 2);
    ...
    public async Task REQ408_GetClosedRoundLeaderboardAsync_ClosedRound_TotalMatchesReq206LockedFormulaExactlyAndNeverRecomputes()
    {
        ...
        await SeedGuessAsync(round.Id, alex.Id, cellA, isCorrect: false, attemptCount: 2, finalPoints: ScoringRules.MaxPointsPerCell);
    ...
    public async Task REQ405_GetWindowedLeaderboardAsync_RoundResolution_UsesSingleMostRecentlyClosedRoundOnly()
    {
        ...
        await SeedGuessAsync(mostRecentlyClosedRound.Id, alex.Id, Guid.NewGuid(), isCorrect: false, attemptCount: 2, finalPoints: ScoringRules.MaxPointsPerCell);
