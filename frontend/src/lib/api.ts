...
// first" convention submitSuggestion above already follows for its own
// guest restriction. `title`/`screen` are mandatory (IncidentReportDialog's
...
// updateAdminRoundEndTime above) — never touches isActive. A 400
...
// convention as createPlayerOverride.
...
// convention as lookupPlayerByName's blank-name check.
