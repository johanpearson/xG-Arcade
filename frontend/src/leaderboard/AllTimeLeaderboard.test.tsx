...
// full `LeaderboardScreen` orchestrator (rather than `AllTimeLeaderboard`
// in isolation) because the behavior under test includes the tab-click
// flow a real player uses, which only exists at the orchestrator level;
