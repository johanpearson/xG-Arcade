...
| COMP-05 Games.XGGrid | ADR-0018 (guess-time live-lookup fallback), ADR-0023, ADR-0032, ADR-0035 (home-nation query path), ADR-0050/ADR-0052 (cache-warming failure tracking), ADR-0061 (trophy pool growth), ADR-0068 (responsibility split) |
...
| COMP-11 Games.XGPath | ADR-0045 (puzzle generation), ADR-0041 (attempt cap), ADR-0049 (clue-efficiency scoring), ADR-0051 (round scheduling), ADR-0054/ADR-0055/ADR-0056/ADR-0069 (career data + familiarity + club-scoped prefetch), ADR-0058 (no-repeat cycling), ADR-0059 (club canonicalization) |
